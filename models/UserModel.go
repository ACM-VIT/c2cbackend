...
type User struct {
	...
	ContactNumber     string     `gorm:"type:varchar(20);not null;unique" json:"contact_number" valid:"required~Contact number is required,numeric~Contact number must be numeric"`
